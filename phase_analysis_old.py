...
period = 1.66987725
time, flux = load_lc(lc_file = 'endurance/Final_Pulsation_LC.txt', parts_of_lc=False, plot = False)
phase =  time%(period)/period

time_f, flux_f = load_lc(lc_file = 'endurance/RS_Cha_lightcurve.txt', parts_of_lc=False, plot = False)
phase_f = time_f%(period)/period
